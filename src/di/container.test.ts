...
describe('DIContainer', () => {
  ...
  describe('Middleware and Interceptors', () => {
    ...
    describe('Async Middleware', () => {
      ...
      it('handles errors in async middleware', async () => {
        ...
        await expect(container.resolveAsync<MiddlewareService>('MiddlewareService')).rejects.toThrow(
  ...
  describe('Modules', () => {
    ...
    it('register a provider as a class reference', () => {
      ...
      class TestClass2 {
        constructor(@Inject(TestClass) public test: TestClass) {}
      }
  ...
  describe('DI Container Self Injection', () => {
    ...
    it('should inject DIContainer into a service', () => {
      ...
      class ServiceWithContainer {
        constructor(@InjectContainer() private container: DIContainer) {}
