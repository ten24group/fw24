...
export type Merged<T1, T2> = T1 extends Nullable
  ? T2 // [Nullable, T2] -> T2
  : T2 extends Nullable
    ? T1 // [T1, Nullable] -> T1
...
type MergedMap<T1 extends MergeableMap, T2 extends MergeableMap> =
  T1 extends Map<infer K1, infer V1> ? (T2 extends Map<infer K2, infer V2> ? Map<K1 | K2, V1 | V2> : never) : never;

type MergedSet<T1 extends MergeableSet, T2 extends MergeableSet> = Set<
  (T1 extends Set<infer Value1> ? Value1 : never) | (T2 extends Set<infer Value2> ? Value2 : never)
>;

type MergedMany<T extends unknown[]> = T extends [infer T1, ...infer Rest]
  ? Rest extends []
    ? T1 // [T1] -> T1
    : T1 extends Nullable
...
const isObject = (obj: unknown): obj is MergeableObject => Object.prototype.toString.call(obj) === '[object Object]';
...
const isMergeable = (obj: unknown): obj is Mergeable =>
  (isObject(obj) && !isNonMergeableObject(obj)) || isArray(obj) || isMap(obj) || isSet(obj);
