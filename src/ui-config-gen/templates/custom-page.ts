...
export interface PropertyConfig {
    ...
    // These are renderer props that can be set in manual page configs or are
    // emitted by the code-gen when the entity attribute carries them.
    // Correspond to IFieldTypeProperties in base-entity.ts.
    // =========================================================================
    ...
    // =========================================================================
    // SELECT field-type-specific props
    // =========================================================================
...
// ============================================================================
// TypedPropertyConfig — Discriminated union for type-safe config authoring (#7)
// ============================================================================
 ...
 */
type PropertyBase = Omit<PropertyConfig,
    | 'fieldType'
    // Number / slider / rating props (declared in PropertyConfig above)
    | 'min' | 'max' | 'step' | 'marks' | 'vertical'
    | 'currencySymbol' | 'precision'
    | 'count' | 'allowHalf'
    // Duration / TTL props
    | 'durationUnit' | 'durationFormat'
    | 'ttlUnit' | 'ttlFormat' | 'ttlAutoRefresh'
    // Code editor props
    | 'codeLanguage' | 'height' | 'darkTheme' | 'lineNumbers' | 'validateJson'
    // Timeline prop
    | 'timelineConfig'
    // Select props
    | 'options' | 'dependsOn' | 'addNewOption' | 'addNewOptionConfig' | 'quickCreate'
>;
...
export type TypedPropertyConfig =
    | (PropertyBase & { fieldType: 'text' | 'textarea' | 'password' | 'email' | 'url' | 'phone' | 'hidden' | 'link' | 'longtext' | 'custom' })
    | (PropertyBase & { fieldType: 'number' | 'percentage'; min?: number; max?: number; })
    | (PropertyBase & { fieldType: 'currency'; currencySymbol?: string; precision?: number; min?: number; })
    | (PropertyBase & { fieldType: 'slider' | 'range'; min?: number; max?: number; step?: number; marks?: Record<number, string>; vertical?: boolean; })
    | (PropertyBase & { fieldType: 'rating'; count?: number; allowHalf?: boolean; })
    | (PropertyBase & { fieldType: 'duration'; durationUnit?: 'ms' | 'seconds' | 'minutes' | 'hours' | 'days'; durationFormat?: 'auto' | 'long' | 'short' | 'compact'; })
    | (PropertyBase & { fieldType: 'ttl'; ttlUnit?: 'ms' | 'seconds' | 'minutes' | 'hours'; ttlFormat?: 'auto' | 'long' | 'short' | 'compact'; ttlAutoRefresh?: number; })
    | (PropertyBase & { fieldType: 'date' | 'datetime' | 'time'; })
    | (PropertyBase & { fieldType: 'boolean' | 'switch' | 'toggle' | 'checkbox'; })
    | (PropertyBase & { fieldType: 'select' | 'multi-select' | 'autocomplete' | 'radio' | 'tags' | 'icon'; options?: FieldOptions<any>; dependsOn?: string | string[]; addNewOption?: boolean; addNewOptionConfig?: any; quickCreate?: any; })
    | (PropertyBase & { fieldType: 'json' | 'rich-text' | 'wysiwyg' | 'markdown'; height?: number; })
    | (PropertyBase & { fieldType: 'code'; codeLanguage?: 'json' | 'html' | 'javascript' | 'handlebars' | 'text'; height?: number; darkTheme?: boolean; lineNumbers?: boolean; validateJson?: boolean; })
    | (PropertyBase & { fieldType: 'badge' | 'tag' | 'color' | 'progress' | 'avatar'; })
    | (PropertyBase & { fieldType: 'file' | 'image' | 'video' | 'audio' | 'qrcode'; })
    | (PropertyBase & { fieldType: 'timeline'; timelineConfig?: PropertyConfig[ 'timelineConfig' ]; });
 ...
 * ```
 */
export function defineProperty<T extends TypedPropertyConfig>(config: T): T {
    return config;
}
...
export interface ListPageConfigStructure {
    ...
    virtualScroll?: { enabled: boolean; height?: number };
    ...
    viewSwitcher?: {
        ...
        kanbanConfig?: {
            ...
            card: { titleField: string; descriptionField?: string; summaryFields?: string[] };
            allowDrag?: boolean;
...
export function makeCustomPageConfig(options: CustomPageOptions) {
    ...
    switch (options.pageType) {
        ...
        case "kanban":
            return {
                ...baseConfig,
                kanbanPageConfig: options.kanbanPageConfig
            };
        case "tree":
            return {
                ...baseConfig,
                treePageConfig: options.treePageConfig
            };
        case "calendar":
            return {
                ...baseConfig,
                calendarPageConfig: options.calendarPageConfig
            };
        case "map":
            return {
                ...baseConfig,
                mapPageConfig: options.mapPageConfig
            };
        default:
            return baseConfig;
    }
