...
export class MailerConstruct implements FW24Construct {
  ...
  public async construct() {
    ...
    this.mainStack = this.fw24.getStack(
      this.mailerConstructConfig.stackName,
      this.mailerConstructConfig.parentStackName,
    );
    ...
    if (
      this.mailerConstructConfig.templatesDirectory === undefined ||
      this.mailerConstructConfig.templatesDirectory === ''
    ) {
