...
export class CertificateConstruct implements FW24Construct {
  ...
  public async construct() {
    this.mainStack = this.fw24.getStack(
      this.certificateConstructConfig.stackName,
      this.certificateConstructConfig.parentStackName,
    );
    ...
    if (this.certificateConstructConfig.certificateArn) {
      certificate = Certificate.fromCertificateArn(
        this.mainStack,
        this.fw24.appName + this.certificateConstructConfig.domainName + '-certificate',
        this.certificateConstructConfig.certificateArn,
      );
    ...
    this.fw24.setConstructOutput(
      this,
      this.certificateConstructConfig.domainName,
      certificate,
