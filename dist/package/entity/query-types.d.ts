...
export type StringLiteralToType<T> = T extends 'string' ? string : T extends 'number' ? number : T extends 'boolean' ? boolean : T extends 'array' ? Array<any> : T extends 'set' ? Array<any> : T extends 'list' ? Array<any> : T extends 'object' ? Record<string, any> : T extends 'map' ? Map<any, any> : any;
/**
...
export declare function isComplexFilterValue<T>(payload: any): payload is ComplexFilterOperatorValue<T>;
/**
...
export type FilterOperators<T> = {
    ...
    'bt': FilterOperatorValue<[from: T, to: T]> | FilterOperatorValue<{
        from: T;
        to: T;
    }>;
...
export declare const allFilterOperators: Array<keyof FilterOperatorsExtended<any>>;
export type FilterOperatorsForDynamo<T> = Exclude<FilterOperatorsExtended<T>, 'endsWith'>;
export declare const filterOperatorsForDynamo: Array<keyof FilterOperatorsForDynamo<any>>;
...
export declare function isFilterCriteria<T>(payload: any): payload is TypedFilterCriteria<T>;
export type AttributeFilter<AttrType = string, ValueType = any> = TypedFilterCriteria<ValueType> & {
    attribute: AttrType;
};
export declare function isAttributeFilter(payload: any): payload is AttributeFilter;
/**
...
export declare function isGenericTypedFilter(payload: any): payload is GenericTypedFilter;
export type GenericFilterGroup<T extends Record<string, any> = Record<string, any>> = IdAndLabel & {
    [op in LogicalOperator]?: Array<ExclusiveUnion<GenericFilterGroup<T> | GenericTypedFilter<T> | AttributeFilter<keyof T, T[keyof T]['type']>>>;
};
export declare function isGenericFilterGroup(payload: any): payload is GenericFilterGroup;
export type GenericFilterCriteria<T extends Record<string, any> = Record<string, any>> = ExclusiveUnion<GenericFilterGroup<T> | GenericTypedFilter<T>>;
/**
...
export declare function isEntityFilter<E extends EntitySchema<any, any, any>>(payload: any): payload is EntityFilter<E>;
/**
...
export declare function isEntityFilterGroup<E extends EntitySchema<any, any, any>>(payload: any): payload is EntityFilterGroup<E>;
/**
...
export declare function isArrayOfObjectOfStringKeysAndBooleanValues(payload: any): payload is Array<ObjectOfStringKeysAndBooleanValues>;
export type ParsedEntityAttributePaths = {
    [key: string]: boolean | {
        attributes: ParsedEntityAttributePaths;
    };
};
