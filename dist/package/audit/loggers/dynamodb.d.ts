...
import { BaseEntityService, type EntityQuery } from '../../entity';
    ...
    readonly model: {
        ...
        readonly viewPageColumnsConfig: {
            readonly columns: [{
                ...
                readonly fields: ["auditId", "entityName", "eventType", "timestamp", "identifiers", "tenant", "actor", "entity", "data"];
            }];
        };
    };
    readonly attributes: {
    ...
    readonly indexes: {
        ...
        readonly gsi2: {
            ...
            readonly pk: {
                ...
                readonly composite: readonly ["eventType"];
            };
            readonly sk: {
