 ...
 */
export declare function observedCall<T>(operation: string, fn: () => Promise<T>, options?: ObservedCallOptions): Promise<T>;
/**
 * Wrap a synchronous external call with an observability span.
 *
 * Same as `observedCall` but for synchronous operations.
 */
export declare function observedCallSync<T>(operation: string, fn: () => T, options?: ObservedCallOptions): T;
