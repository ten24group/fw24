...
export type SearchQueryTyped<T extends SearchIndexSettings> = Omit<SearchQuery, 'searchAttributes' | 'sort' | 'select' | 'distinct' | 'facets' | 'filters'> & {
    ...
    sort?: Array<{
        field: Extract<ValueOf<T['sortableAttributes']>, string>;
        dir: 'asc' | 'desc';
    }>;
};
export type ExtractEntitySearchableAttributes<E extends EntitySchema<any, any, any, any>> = ExtractEntitySearchConfigAttributesOfType<'searchableAttributes', E> extends never ? ExtractEntityAttributesOfType<'isSearchable', E> : ExtractEntitySearchConfigAttributesOfType<'searchableAttributes', E>;
export type ExtractEntityFilterableAttributes<E extends EntitySchema<any, any, any, any>> = ExtractEntitySearchConfigAttributesOfType<'filterableAttributes', E> extends never ? ExtractEntityAttributesOfType<'isFilterable', E> : ExtractEntitySearchConfigAttributesOfType<'filterableAttributes', E>;
export type ExtractEntitySortableAttributes<E extends EntitySchema<any, any, any, any>> = ExtractEntitySearchConfigAttributesOfType<'sortableAttributes', E> extends never ? ExtractEntityAttributesOfType<'isSortable', E> : ExtractEntitySearchConfigAttributesOfType<'sortableAttributes', E>;
export type ExtractEntitySelectableAttributes<E extends EntitySchema<any, any, any, any>> = ExtractEntitySearchConfigAttributesOfType<'selectableAttributes', E> extends never ? ExtractEntityAttributesOfType<'isListable', E> : ExtractEntitySearchConfigAttributesOfType<'selectableAttributes', E>;
export type ExtractEntityAttributesOfType<T extends keyof BaseFieldMetadata, E extends EntitySchema<any, any, any, any>> = Extract<keyof OmitNever<{
    [K in keyof E['attributes']]: E['attributes'][K][T] extends false ? never : K;
}>, string>;
type ExtractEntitySearchConfigAttributesOfType<T extends keyof SearchIndexSettings, E extends EntitySchema<any, any, any, any>> = E['model']['search'] extends {
    indexConfig: {
        settings: {
            [K in T]: string[];
        };
    };
} ? Extract<ValueOf<E['model']['search']['indexConfig']['settings'][T]>, string> : never;
/**
