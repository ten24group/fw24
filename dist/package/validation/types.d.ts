...
export interface TestValidationResult extends ValidationExpectedAndReceived {
    pass: boolean;
    error?: string;
}
...
export type OpValidatorOptions<Sch extends EntitySchema<any, any, any>, OpName extends keyof Sch['model']['entityOperations'], ConditionsMap extends MapOfValidationCondition<any, any>, OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = {
...
export type ValidateHttpRequestOptions<Header extends InputType = InputType, Body extends InputType = InputType, Param extends InputType = InputType, Query extends InputType = InputType> = {
...
export interface IValidator {
    validateEntity<Sch extends EntitySchema<any, any, any>, OpName extends keyof Sch['model']['entityOperations'], ConditionsMap extends MapOfValidationCondition<any, any>, OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>>(options: OpValidatorOptions<Sch, OpName, ConditionsMap, OpsInpSch>): Promise<ValidatorResult>;
...
export declare const Validation_Keys: Array<keyof Validations<any>>;
/**
 ...
 */
export type HttpRequestValidations<Header extends InputType = InputType, Body extends InputType = InputType, Param extends InputType = InputType, Query extends InputType = InputType> = {
 ...
 *
 */
export type EntityOperationValidationRuleForInput<Input, Sch extends EntitySchema<any, any, any>, ConditionsMap extends MapOfValidationCondition<any, any>, OpsKeys extends keyof Sch['model']['entityOperations'], OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = {
    readonly operations?: Narrow<Array<OpsKeys | ValueOf<{
        readonly [OppName in OpsKeys]: OperationConditionsTuple<Sch, ConditionsMap, OppName, OpsInpSch>;
    }>> | {
 ...
 */
export type OperationConditionsTuple<Sch extends EntitySchema<any, any, any>, ConditionsMap extends MapOfValidationCondition<any, any>, OppName extends keyof Sch['model']['entityOperations'], OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = [
    op: OppName,
    /**
 ...
 * @template OpsInpSch - The input schemas for entity operations.
 */
export type OperationConditions<Sch extends EntitySchema<any, any, any>, ConditionsMap extends MapOfValidationCondition<any, any>, OppName extends keyof Sch['model']['entityOperations'], OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = {
    /**
...
export type InputApplicableCondition<Inp extends InputType, C extends EntityValidationCondition<any, any>> = {
    ...
    readonly input: C['input'] extends undefined ? void : keyof C['input'] extends keyof Inp ? C['input'] : void;
};
export type InputApplicableConditionsMap<Inp extends InputType, ConditionsMap extends MapOfValidationCondition<any, any>> = OmitNever<{
    readonly [ConditionName in keyof ConditionsMap]: InputApplicableCondition<Inp, ConditionsMap[ConditionName]> extends ConditionsMap[ConditionName] ? ConditionsMap[ConditionName] : never;
}>;
/**
...
export type ConditionalValidationRule<T, ConditionsMap extends MapOfValidationCondition<InputType, RecordType>> = {
     ...
     */
    readonly conditions?: Array<keyof ConditionsMap> | [
 ...
 */
export type EntityOperationsValidation<Sch extends EntitySchema<any, any, any>, ConditionsMap extends MapOfValidationCondition<any, any>, OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = Narrow<{
    /**
     * Represents the validation for each entity operation.
     */
    readonly [oppName in keyof OpsInpSch]?: EntityOperationValidation<Narrow<OpsInpSch[oppName]>, // operation input schema
...
export type EntityValidations<Sch extends EntitySchema<any, any, any, any>, ConditionsMap extends MapOfValidationCondition<any, any> = any, OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = Narrow<{
    readonly actor?: {
        [ActorKey in keyof Actor]?: Narrow<EntityOperationValidationRuleForInput<Actor[ActorKey], Sch, ConditionsMap, keyof OpsInpSch>>[];
    };
    readonly record?: {
        [RecordKey in keyof EntityRecordTypeFromSchema<Sch>]?: Narrow<EntityOperationValidationRuleForInput<EntityRecordTypeFromSchema<Sch>[RecordKey], Sch, ConditionsMap, keyof OpsInpSch>>[];
    };
    readonly input?: {
        [Prop in keyof EntityRecordTypeFromSchema<Sch>]?: Array<EntityOperationValidationRuleForInput<EntityRecordTypeFromSchema<Sch>[Prop], Sch, ConditionsMap, keyof PropertyApplicableEntityOperations<Prop, Sch, OpsInpSch>>>;
    };
}> & {
 ...
 * @template OpsInpSch - The entity operations input schemas type.
 */
export type EntityInputValidations<Sch extends EntitySchema<any, any, any, any>, OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = {
...
export type PropertyApplicableEntityOperations<Prop, Sch extends EntitySchema<any, any, any, any>, OpsInpSch extends EntityOperationsInputSchemas<Sch> = EntityOperationsInputSchemas<Sch>> = OmitNever<{
